...
SECRET_KEY = 'django-insecure-mnok^v8o3dv^+&*owudy6$5y&6ae!%^yh(taw*nlhsq@4pwd#s'
...
INSTALLED_APPS = [
    ...
    # my_app
    'api',
    # cors to connect rest api with rest framework
    'corsheaders',
    'rest_framework',
]
...
MIDDLEWARE = [
    ...
    # to handle static files in production --- whitenoise
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # adding file to built index file of compliled react frontend
